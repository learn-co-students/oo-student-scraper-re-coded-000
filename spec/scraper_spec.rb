...
describe "Scraper" do
  ...
  let!(:student_index_array) {[{:name=>"Joe Burgess", :location=>"New York, NY", :profile_url=>"http://46.101.236.30:30018/students/joe-burgess.html"},
                               {:name=>"Mathieu Balez", :location=>"New York, NY", :profile_url=>"http://46.101.236.30:30018/students/mathieu-balez.html"},
                               {:name=>"Diane Vu", :location=>"New York, NY", :profile_url=>"http://46.101.236.30:30018/students/diane-vu.html"}]}
 ...
 :bio=>
  ...
  describe "#scrape_index_page" do
    it "is a class method that scrapes the student index page and a returns an array of hashes in which each hash represents one student" do
      index_url = "http://46.101.236.30:30018/fixtures/student-site/index.html"
  ...
  describe "#scrape_profile_page" do
    it "is a class method that scrapes a student's profile page and returns a hash of attributes describing an individual student" do
      profile_url = "http://46.101.236.30:30018/fixtures/student-site/students/joe-burgess.html"
    ...
    it "can handle profile pages without all of the social links" do
      profile_url = "http://46.101.236.30:30018/fixtures/student-site/students/david-kim.html"
      scraped_student = Scraper.scrape_profile_page(profile_url)
      expect(scraped_student).to be_a(Hash)
